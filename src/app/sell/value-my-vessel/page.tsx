...
const BOAT_MAKES = [
  ...
  'Jupiter', 'Intrepid', 'Cape Horn', 'Pro-Line',
  // Sportfish / Convertibles
  'Viking', 'Hatteras', 'Bertram', 'Cabo', 'Riviera', 'Ocean', 'Luhrs',
  'Tiara', 'Blackfin', 'Jarvis Newman', 'Spencer', 'Paul Mann',
  'Rybovich', 'Merritt', 'Winter Custom Yachts', 'Buddy Davis', 'Post',
  'Striker', 'Topaz', 'Davis', 'Garlington',
  // Luxury Motor Yachts
  'Princess', 'Sunseeker', 'Ferretti', 'Pershing', 'Riva',
  'Benetti', 'Lurssen', 'Sunreef', 'Mangusta', 'Leopard', 'Cranchi',
  'Sanlorenzo', 'Monte Carlo Yachts', 'Numarine', 'Westport',
  'Feadship', 'Heesen', 'Baglietto', 'Sealine',
  // Catamarans
  'Lagoon', 'Fountaine Pajot', 'Privilege',
  // Performance
