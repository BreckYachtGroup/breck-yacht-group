      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
              ...
              {stage === 'unlocked' && (
                <div className="space-y-6">
                  <div className="bg-green-50 border border-green-100 rounded px-4 py-3 text-sm text-green-700">
                    ✓ Report unlocked. Breck Yacht Group will be in touch to compare notes.
                  </div>
        ...
        <div className="bg-white shadow-sm border border-gray-100 p-8">
          <div className="border-l-4 pl-4 mb-8" style={{ borderColor: '#0c1f3f' }}>
            ...
            <p className="text-sm text-gray-400 mt-1">Personal valuation from Breck Yacht Group within 24 hours</p>
          </div>

          <p className="text-sm text-gray-500 leading-relaxed mb-8">
            While our AI tool gives you an instant data-driven range, nothing replaces a broker who knows the market firsthand. Fill out the form below and a Breck Yacht Group broker will review your vessel personally and follow up with a detailed market opinion.
          </p>
