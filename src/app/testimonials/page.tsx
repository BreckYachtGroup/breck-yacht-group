    ...
    <div style={{ backgroundColor: '#f8f6f1' }} className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
        {loading ? (
          ...
          <div className="text-center text-gray-400 py-12 text-sm">Be the first to leave a testimonial.</div>
        ) : (
        ...
        <div>
          ...
          {submitted ? (
            <div className="bg-white p-10 shadow-sm text-center">
              ...
              <p className="text-gray-500 text-sm">Your testimonial has been submitted and will appear on the site after review.</p>
            </div>
          ) : (
